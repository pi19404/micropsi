...
public class MovementAction implements ActionTranslatorIF {
	...
	public MAction calculateAction() {
		...
		movementAction.addParameter(Double.toString(left.getSignal()));
		movementAction.addParameter(Double.toString(right.getSignal()));
		movementAction.addParameter(Double.toString(back.getSignal()));

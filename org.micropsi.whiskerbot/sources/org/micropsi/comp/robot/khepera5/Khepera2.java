...
public class Khepera2 {
	...
	public Khepera2(BufferedWriter out, BufferedReader answer, Logger logger){
		Khepera2.command = out;
		Khepera2.answer = answer;
		this.logger = logger;
	}
	
	public Khepera2(OutputStreamWriter out, BufferedReader answer, Logger logger){
		Khepera2.out = out;
		Khepera2.answer = answer;
		this.logger = logger;
	...
	public int setSpeed_motor(String speed_motor_left, String speed_motor_right) {
		...
		Khepera2.speed_motor_left = speed_motor_left;	
		Khepera2.speed_motor_right = speed_motor_right;
		return 1;
	}
	...
	public int stop() {
		...
		Khepera2.speed_motor_right = "0";
		Khepera2.speed_motor_left = "0";
	...
	public String getSpeed_motor_left() {
		return Khepera2.speed_motor_left;
	}
	...
	public String getSpeed_motor_right() {
		return Khepera2.speed_motor_right;
	}

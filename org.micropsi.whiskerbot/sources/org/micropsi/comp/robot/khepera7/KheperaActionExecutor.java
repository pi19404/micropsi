...
import org.micropsi.comp.robot.khepera7.conserv.QTypeExternalPositioning;
import org.micropsi.comp.robot.khepera7.conserv.QTypeReset;
import org.micropsi.comp.robot.khepera7.conserv.QTypeTalkative;
...
public class KheperaActionExecutor extends RobotActionExecutor {
  ...
  public MActionResponse executeAction(MAction action) {
    ...
    if(khepera == null) {    	
    	...
    	//khepera = new Khepera("COM1", true, logger, debug);
    	logger.info("creating khepera instance...");
    }
...
//    stop_prox = System.currentTimeMillis();
    ...
    bodyPropertyChange1.setValue(khepera.getPs1());
    ...
    bodyPropertyChange2.setValue(khepera.getPs2());
    ...
    bodyPropertyChange3.setValue(khepera.getPs3());
    ...
    bodyPropertyChange4.setValue(khepera.getPs4());
    ...
    bodyPropertyChange5.setValue(khepera.getPs5());
    ...
    bodyPropertyChange6.setValue(khepera.getPs6());
    ...
    bodyPropertyChange7.setValue(khepera.getPs7());
    ...
    bodyPropertyChange8.setValue(khepera.getPs8());
    ...
    bodyPropertyChange9.setValue(khepera.getLs1());
    ...
    bodyPropertyChange10.setValue(khepera.getLs2());
    ...
    bodyPropertyChange11.setValue(khepera.getLs3());
    ...
    bodyPropertyChange12.setValue(khepera.getLs4());
    ...
    bodyPropertyChange13.setValue(khepera.getLs5());
    ...
    bodyPropertyChange14.setValue(khepera.getLs6());
    ...
    bodyPropertyChange15.setValue(khepera.getLs7());
    ...
    bodyPropertyChange16.setValue(khepera.getLs8());

/*
 * $Header: G:\DEV\Workspace\migration3.0\micropsi-cvs-repository\micropsi/org.micropsi.3dviewer/sources/org/micropsi/eclipse/viewer3d/win32/LibLoaderClassLoader.java,v 1.4 2004/09/09 16:34:28 vuine Exp $ 
 */
...
import org.micropsi.eclipse.viewer3d.Viewer3DPlugin;
...
public class LibLoaderClassLoader extends ClassLoader {
	...
	public LibLoaderClassLoader() throws IOException {
		...
		String libLoaderFile = Platform.asLocalURL(Viewer3DPlugin.getDefault().find(new Path("LibLoader.class"))).getFile();

/**
 * $Header: G:\DEV\Workspace\migration3.0\micropsi-cvs-repository\micropsi/org.micropsi.core/sources/org/micropsi/comp/world/objects/SteamVehicleAgentObject.java,v 1.11 2005/07/12 12:55:16 vuine Exp $
 */
 ...
 *
 */
public class SteamVehicleAgentObject extends AbstractAgentObject {
	...
	public class MoveAction extends AbstractAction {
		...
		public void tick(long simStep) {
			for (long i = lastSimstep;i < simStep; i++) {
				WorldVector res = world.getEffectiveMoveVector(SteamVehicleAgentObject.this, effortVec);
		...
		public void finish(double success) {
			world.getHighResolutionTimer().unsubscribe(SteamVehicleAgentObject.this);
			super.finish(success);
			if (success > 0) {
				world.getLogger().debug(world.getSimStep()
						+ ": Agent "
						+ SteamVehicleAgentObject.this.getObjectName()
		...
		public void start() {
			...
			world.getHighResolutionTimer().subscribe(SteamVehicleAgentObject.this);
		}
	}
	...
	public class EatAction extends AbstractAction {
		...
		public void execute() {
			...
			AbstractWorldMessage m = new WorldMessage("AGENTACTION", "eat", SteamVehicleAgentObject.this);
		...
		public void start() {
			if (targetObject == null) {
				...
				WorldMessage m = new WorldMessage("ACTIONMANAGEMENT", "executeaction", SteamVehicleAgentObject.this);
				m.addParameter(this);
				world.getPostOffice().send(m, SteamVehicleAgentObject.this, world.getSimStep() + 10);
				setState("Action", "Eat");
			}
		}
	}
	...
	public class DrinkAction extends AbstractAction {
		...
		public void execute() {
			...
			AbstractWorldMessage m = new WorldMessage("AGENTACTION", "drink", SteamVehicleAgentObject.this);
			m.setCollectAnswers(true);
			world.getPostOffice().send(m, targetObject);
	...
	public SteamVehicleAgentObject(String objectName, String objectClass, Position pos) {
		super(objectName, objectClass, pos);
		gridBasePosition = pos;
	}
	
	public SteamVehicleAgentObject(String objectName, Position pos) {
		this(objectName, "SteamVehicleAgent", pos);
	}

	public SteamVehicleAgentObject(Element configData, Logger logger) throws MicropsiException {

 ...
 */
public class WaterHoleObject extends AbstractCommonObject {

	protected double waterContent;
	protected double maxWaterContent;

	public WaterHoleObject(String objectName, String objectClass, Position pos) {
		super(objectName, objectClass, pos);
	}

	public WaterHoleObject(Element configData, Logger logger) throws MicropsiException {

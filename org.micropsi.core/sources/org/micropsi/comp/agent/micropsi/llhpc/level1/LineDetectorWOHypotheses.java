...
public class LineDetectorWOHypotheses {
	...
	public LineDetectorWOHypotheses(Logger logger, int sizeX, int sizeY) throws MicropsiException, IOException {
		this.logger = logger;
	...
	public void detectLines(BufferedImage img, boolean allowDelay) throws MicropsiException {
		image = img;
		...
		for(imagex=0;imagex<image.getWidth()/10;imagex++) {
			for(imagey=0;imagey<image.getHeight()/10;imagey++) {
				detectLine(img,imagex,imagey,true);
			}			
		}
	}
	
	public void detectLine(BufferedImage img ,int x, int y, boolean allowDelay) throws MicropsiException { 
...
//	public void detectLines(BufferedImage img, int shiftx, int shifty, boolean allowDelay) throws MicropsiException {
//		image = img;
//		
//		imagex = 0;
//		imagey = 0;

/**
 * $Header: G:\DEV\Workspace\migration3.0\micropsi-cvs-repository\micropsi/org.micropsi.core/sources/org/micropsi/comp/world/objects/BananaTreeObject.java,v 1.4 2005/07/12 12:55:16 vuine Exp $
 */
 ...
 *
 */
public class BananaTreeObject extends PlantObject {
	 ...
	 * @param pos
	 */
	public BananaTreeObject(String objectName, String objectClass, Position pos) {
		super(objectName, objectClass, pos);
	}

	public BananaTreeObject(Element configData, Logger logger) throws MicropsiException {

 ...
 * @author Joscha
 */
public class WaterHoleEmptyObject extends AbstractCommonObject {

	protected double waterContent;
	protected double maxWaterContent;

	public WaterHoleEmptyObject(String objectName, String objectClass, Position pos) {
		super(objectName, objectClass, pos);
	}

	public WaterHoleEmptyObject(Element configData, Logger logger) throws MicropsiException {
	...
	public void _handleMessage(AbstractWorldMessage m) {
		...
		if (m.isContent("drink")) {
			m.answer(new ConsumeResponseMessage(0, 0, 0, null));
		}
	}

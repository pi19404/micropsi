 ...
 *
 */
public class BatteryObject extends AbstractCommonMarsianObject implements MarsianEatableIF, AgingIF {
	 ...
	 */
	public BatteryObject(Element configData, Logger logger) throws MicropsiException {
